<template>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <template v-for="product in paginatedAndFilteredProducts" :key="product.id">
                    <tr>
                        <td>
                            <button v-if="product.variants && product.variants.length > 0"
                                @click="toggleVariants(product.id)" class="btn btn-sm">
                                        ...
                                        <tr v-for="variant in product.variants" :key="variant.id">
                                            ...
                                            <td>
                                                <template v-for="item in variant.images">
                                                    <img :src="item.image_url" alt="Variant Image"
                                                        class="variant-image me-1" @click="openImage(item.image_url)" />
                                                </template>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-wrap gap-1">
                                                    <span v-for="attr in variant.attributes"
                                                        :key="attr.attribute_value_id" class="badge bg-primary">
                                                        {{ attr.attribute_name }}
                                                    </span>
                                                </div>
                                            </td>
...
const filteredProducts = computed(() => {
    let listToFilter = allProducts.value;
